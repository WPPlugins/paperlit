...
echo'
    ...
    edition = ' . $post->ID . ';
    window.open("' . admin_url() . '/admin-ajax.php?action=render_console&paperlit_no_theme=true&edition_id=" + edition + "&packager_type="+ paperlit_packager_type_id.options[paperlit_packager_type_id.selectedIndex].value, "_blank").focus();return false;};
    }, false);
    </script>';
	}
